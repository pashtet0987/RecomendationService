...
public class KafkaConfiguration {
    ...
    public static Map<String, Object> consumerProperties(String kafkaBrokers) {
    ...
    public ConsumerFactory<Long, RecomendationDTO> defaultKafkaConsumerFactory(@Value("${kafka.configuration.bootstrapServers}") String kafkaBrokers) {
        DefaultKafkaConsumerFactory<Long, RecomendationDTO> factory = new DefaultKafkaConsumerFactory<>(consumerProperties(kafkaBrokers));
        return factory;
    }
